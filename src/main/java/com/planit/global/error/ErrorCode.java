...
public enum ErrorCode {
    ...
    INVITATION_NOT_FOUND(HttpStatus.NOT_FOUND, "초대 링크가 유효하지 않습니다."),
    INVITATION_TRIP_DELETED(HttpStatus.GONE, "삭제된 여행방의 초대 링크입니다."),
    INVITATION_EXPIRED(HttpStatus.GONE, "만료된 초대 링크입니다."),
    SURVEY_CLOSED(HttpStatus.CONFLICT, "설문이 마감된 여행방입니다."),
